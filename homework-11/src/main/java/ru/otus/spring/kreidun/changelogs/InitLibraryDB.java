...
public class InitLibraryDB {
        ...
        public void initGenres(MongoTemplate template) {
            ...
            genre3 = template.save(new Genre("Детектив"));
        }
        ...
        public void initSAuthors(MongoTemplate template) throws ParseException {
            ...
            author3 = template.save(new Author("Агата", "Кристи"));
        }
        ...
        public void initBooks(MongoTemplate template) {
            ...
            template.save(new Book("Час Быка", author2, genre2));
            template.save(new Book("Убийство в «Восточном экспрессе»", author3, genre3));
        }
        ...
        public void initComments(MongoTemplate template) {
            ...
            template.save(new Comment ("Не читал", book1));
        }
}
