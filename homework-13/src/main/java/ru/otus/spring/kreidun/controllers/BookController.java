...
import ru.otus.spring.kreidun.services.AclMyService;
import ru.otus.spring.kreidun.services.LibraryService;
...
public class BookController {
    ...
    public BookController(BookRepository repository, GenreRepository genreRepository,
                          AuthorRepository authorRepository, CommentRepository commentRepository, LibraryService libraryService, AclMyService aclMyService) {
    ...
    public String postSaveBook(
        ...
        if (id!=0) {
            book = repository.findById(id).orElseThrow();
            book.setTitle(title);
